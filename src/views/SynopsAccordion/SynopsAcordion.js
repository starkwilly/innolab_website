...
import '../../components/AccordionCard/AccordionCard.css';
                        ...
                        <Accordion.Collapse eventKey={`${idx}`}>                       
                            <Card.Body>       
                                    <Row className="no-gutters">
                                        ...
                                        <Col xs={12} md={12} lg={12} className="card-text">
                                            <RenderMarkdown >{accordionItm.SectionBody}</RenderMarkdown>
...
SynopsAcordion.propTypes = {
    cardInfo: PropTypes.any.isRequired,
}

export default SynopsAcordion;